...
(function()
{
    ...
    function DisplayHomePage(): void
    {
        ...
        My name is Alyxander Byfield. A soon-to-be Computer Programmer Graduate from Durham College. \n
        I have been programming for many years and am adept with object oriented programming and it's principles. 
        I also have experience with Front/Back end MEAN web development, COBOL, Python, etc.
        </p>`);
        //Article.innerHTML = ArticleParagraph;
        $("main").append(`<article>
        <p id="ArticleParagraph" class="mt-3">This website serves as a portfolio and also the final lab submission
        for my winter 2022 web development class.\n
        The website is programmed using typescript and express. It features a MVC framework and a database hosted
        on MongoDB Atlas with full Create, Read, Update, and Delete functionality. </p>
        </article>`); 
        $("main").append(`<button id="AboutUsButton" class="btn btn-primary">Learn more About Me!</button>`);
